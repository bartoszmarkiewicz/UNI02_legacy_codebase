...
//STANDARD
    ...
    if(!PFNf_EnF10V&&(PFNf_LIN_BPSS||!PFNf_LIN_KSK)&&(PFNf_LIN_BPSS||!PFNf_LIN_STR)&&!PFNf_LIN_PWD&&!PFNf_LIN_BUF&&!(OTMaster.Ref._Control_Setpoint&&PFNf_FOT))    //+++
    {
    ...
    else //dowolny z interfejsow aktywny
    {
        ...
        if(((!PFNf_LIN_BPSS&&PFNf_LIN_KSK)||(!PFNf_LIN_BPSS&&PFNf_LIN_STR)||PFNf_LIN_PWD||PFNf_LIN_BUF)&&PFNf_FLIN)             //interfejs LIN w trybie STR lub KSK?    //+++
        {
            if(!PFNf_LIN_PWD)
            {
        ...
        {
//            PFN.CONTSETP=FormatSETP(PFN.CONTSETP);
//            PFN.INSETP=FormatSETP(PFN.INSETP);
//            if((PFN.INSETP-PFN.CONTSETP)>10)
//            {
//                PFN.CONTSETP=PFN.INSETP-10;
//            }
//            if((PFN.CONTSETP-PFN.INSETP)>10)
//            {
//                PFN.CONTSETP=PFN.INSETP+10;
//            }            
