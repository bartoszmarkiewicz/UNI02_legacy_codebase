...
void PomiarCO(void)
{
    ...
    //dla grzania na parametrach wysokich
    if((DtCO.CO-DtCO.F3PPCO)>=F3_AD_CO) DtCO._ad_UP=1;
    else DtCO._ad_UP=0;
    if((DtCO.F3PPCO-DtCO.CO)>=F3_SU_CO) DtCO._su_UP=1;
    else DtCO._su_UP=0;    
}
#else
void PomiarCO(void)
...
void SetModPCO(void)
{
    ...
    if(M._pob_UP)       //pobudzenie grzania na wysokich parametrach?
    {
        DtCO.PPCO=DtCO.F3PPCO;
        M.CONTSETP=DtCO.PPCO;
        M.SETPmax=DtCO.PPCO;
    ...
    {       
        ...
        {        
            ...
            if(M._I10V_RT||(!M._LIN_BPSS&&(M._LIN_STR||M._LIN_KSK))||M._LIN_PWD||M._LIN_BUF)                   //nastawa zdalna?        
            {   
                M.CONTSETP=RSDT1.inCONTSETP;
                if(!M._LIN_PWD)  
                {
        ...
        {        
            ...
            if(M._I10V_RT||(!M._LIN_BPSS&&(M._LIN_STR||M._LIN_KSK))||M._IOT_STR||M._LIN_PWD||M._LIN_BUF)      //nastawa zdalna?
            {          
                M.CONTSETP=RSDT1.inCONTSETP;
                if(!M._LIN_PWD)  
                {
...
#endif 
#if (_EXT_BOARD==2) 
        (!M._LIN_BPSS&&(M._LIN_STR||M._LIN_KSK))
        //if(M._I10V_RT||M._LIN_STR||M._LIN_KSK||M._LIN_PWD||M._LIN_BUF)                   //nastawa zdalna?
        if(M._I10V_RT||(!M._LIN_BPSS&&(M._LIN_STR||M._LIN_KSK))||M._LIN_PWD||M._LIN_BUF)                   //nastawa zdalna?        
        {   
            M.CONTSETP=RSDT1.inCONTSETP;
