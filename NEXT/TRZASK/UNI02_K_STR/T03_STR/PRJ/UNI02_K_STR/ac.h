...
//----------
#define _NTC_0	0x34			//0x34 wartosc AC dla 99 C - dolny margines tabeli 0x40
							//wartosc AC <= _NTC_0 zwraca 0 C
#define _NTC_99	0xED			//0xed wartosc AC dla 0 C - gorny margines tabeli 0xEF
...
#define _ZNTC_99 0xEC		//wartosc AC dla 0 C - gorny margines tabeli
							//wartosc AC >= _NTC_99 zwraca 99 C
//----------						
#define _AEETZW	0x00F0		//adres poczatku tablicy czujnika NTC
