...
const CDtPZK CPZK[_KNPAR]=
{
	...
	50,89,0b01010100,			//15 temp CO przy grzaniu CW zasobnika
    ...
    0 ,15,0b01010100			//21 przewyzszenie temperaturowe            
};
/*---------------------------------------------------------------------------------*/
//Podstawowe cechy kolejnych parametrow
...
void UpdateKnfPar(unsigned char par)
{
    ...
    {    
        switch(par)
        {
            ...
            break;        
            case 19:
                RSDT1.inCWMG=PZK[19].dta;		//19 histereza wylaczenia CW(4F)   
            break;            
            case 20:
                RSDT1.inCWTM=PZK[20].dta;		//20 we. sygnalu timera zasobnika (1F)   
            break;    
            case 21:
                RSDT1.inPWTM=PZK[21].dta;		//21 przewyzszenie temp.   
            break;             
        }
    }
}
		...
		case 1:
		{
            ...
            {            
                if(RSDT1f_RD_KNF&&PFNf_opKNF)                                   //odczytaj dane wejsciowe parametrów ktore maja byc modyfikowane
                {
                    ...
                    RSDT1.inPWTM=PZK[21].dta=PZK[21].bfdta=RSDT1.outPWTM;       //21 przewyzszenie temp.
