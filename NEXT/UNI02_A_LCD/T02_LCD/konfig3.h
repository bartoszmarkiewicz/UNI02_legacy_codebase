...
/*---------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------*/
#define	_KNPAR  22			//domyslna ogolna liczba parametrow podlegajacych modyfikacji dla ver 5
...
#define	_KNPAR4 18          //wsteczna ogolna liczba parametrow podlegajacych modyfikacji dla ver 4
#define	_KNPAR5 21          //wsteczna ogolna liczba parametrow podlegajacych modyfikacji dla ver 5
#define	_KNPAR6 22          //wsteczna ogolna liczba parametrow podlegajacych modyfikacji dla ver 6
/*---------------------------------------------------------------------------------*/
