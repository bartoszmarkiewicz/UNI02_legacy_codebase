...
#define	_NRT_cS	0		/*liczba timerow typu cS*/
#define	_NRT_dS	14		/*liczba timerow typu dS*/
#define _NRT_S	20		/*liczba timerow typu S*/
#define _NRT_M	7		/*liczba timerow typu M*/
#define _NRT_G	3		/*liczba timerow typu G*/
