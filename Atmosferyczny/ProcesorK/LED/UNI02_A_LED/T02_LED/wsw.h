...
#define NPWD		10					//liczba poziomow priorytetu wyswietlania (rozmiar tablicy PWD)
#define NdPWD		10					//liczba danych dynamicznych wyst. wylacznie w kolejkach
...
#define RSNFRS		1					//1-przy ustawionej fladze "restart" aktywna jest obsluga wyswietlania kolejnych pozycji kolejki 
