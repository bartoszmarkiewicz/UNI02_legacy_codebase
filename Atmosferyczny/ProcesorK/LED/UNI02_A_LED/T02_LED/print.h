...
#define _WS_TDCO	4		//temp dyzurna CO
#define _WS_TDCW	5		//temp dyzurna CW
#define _WS_OFF		6		//wylaczenie
#define _WS_CS		7		//cisnienie
#define _WS_TCW		8		//temperatura CW
#define _WS_TCO		9		//temperatura CO
//--------------------------------------------------------------
...
extern void SetData(volatile WPack *wData,const unsigned char wdt1,const unsigned char wdt0);
...
extern void SetStatus(volatile WPack *wData,const unsigned int wst,const unsigned int mask);
