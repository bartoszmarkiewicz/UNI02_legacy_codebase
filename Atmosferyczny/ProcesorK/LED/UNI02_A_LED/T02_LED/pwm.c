...
void IntPWM(void)
{
    ...
    if(PWMf_ENPWM) //nowa wartosc PWM gotowa do pobrania?
    {
        PWM.NewPWM = PWM.BufPWM;
        PWM.NewOSC = PWM.BufOSC;
    }
    if(PWMf_ENOSC) //aktywny modul oscylacji?
    {
