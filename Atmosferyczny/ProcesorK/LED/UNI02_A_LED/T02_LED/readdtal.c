...
unsigned char ReadData(unsigned char k, volatile StPin *ky, volatile unsigned char *dt, unsigned char min, unsigned char max, const unsigned char step, unsigned char wrn)
{
...
unsigned char ReadDataX(unsigned char k, volatile StPin *ky, volatile unsigned char *dt, unsigned char min, unsigned char max, const unsigned char step, const unsigned char step2, unsigned char wrn)
{
    static bit dtmo = 0, okvi = 0;
...
unsigned char ReadDataONL(unsigned char k, volatile StPin *ky, volatile unsigned char *dt, unsigned char min, unsigned char max, const unsigned char step, unsigned char wrn)
{
    if(*dt < min) *dt = min;
...
unsigned char ReadDataXONL(unsigned char k, volatile StPin *ky, volatile unsigned char *dt, unsigned char min, unsigned char max, const unsigned char step, const unsigned char step2, unsigned char wrn)
{
    static bit dtmo = 0;
...
unsigned char ReadDataXONLI(unsigned char k, volatile StPin *ky, volatile unsigned int *dt, volatile unsigned char *ovf, unsigned int max, const unsigned char step, const unsigned char step2, const unsigned char fst)
{
    static bit dtmo = 0;
...
unsigned char ReadDataXONLD(unsigned char k, volatile StPin *ky, volatile unsigned int *dt, volatile unsigned char *ovf, unsigned int min, const unsigned char step, const unsigned char step2, const unsigned char fst)
{
    static bit dtmo = 0;
    static unsigned char ktu, iu, pp, es2;
    char key = 0;
...
unsigned char ReadDataXONLID(unsigned char k, volatile StPin *ky, volatile unsigned int *dt, volatile unsigned char *ovf, unsigned char tid, unsigned int min, unsigned int max, const unsigned char step, const unsigned char step2, const unsigned char fst)
{
    volatile static bit dtmo = 0;
    volatile static unsigned char ktu, iu, pp, es2;
    volatile char key = 0;
