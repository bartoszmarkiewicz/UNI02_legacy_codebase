...
#define _EXT_BOARD  3       //3 LCD: 0-plytka starego typu, 1-plytka nowego typu z interfejsem 10V, 2-plytka nowego typu z interfejsem 10V i LIN, 3 -plytka nowego typu z interfejsem 10V, LIN i OT
...
#define _RTHPM	10			//pompa.c - oobnizona predkosc wybiegu pompy na czas przelaczenia zaworu 3DR
//*************************************************************
//RTS
...
#define _MOD_CON   	5	//ciaglosc obwodu modulatora (0-rozwarty, 1-zwarty)
                  //6 znacznik aktywnosci zew. reg. pogodowego ustawiany przez plytke LCD
//KONFIGURACJA
//RSDT1.outKSTAT0
