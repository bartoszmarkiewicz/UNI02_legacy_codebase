...
#endif
#if _NRT_cS
volatile near RTcSekundy	cSk[_NRT_cS];//volatile near
#endif
#if _NRT_dS
volatile near RTdSekundy	dSk[_NRT_dS];
#endif
#if _NRT_S
volatile RTsekundy	Sk[_NRT_S];
#endif
#if _NRT_M
volatile RTminuty	Mn[_NRT_M];
#endif
#if _NRT_G
volatile RTgodziny	Gd[_NRT_G];
#endif
