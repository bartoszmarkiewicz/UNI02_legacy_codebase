...
-Wprowadzono wstepne ograniczenie mocy maksymalnej dla grzania CO (aktywacja wymaga minimum 2 wersji oprogramowania LCD)
	{
		...
		Ograniczenie funkcionuje wy?šcznie w trakcie normalnego grzania obiegu CO.
...
-Wprowadzone rozwiazania kompatybilnosci wstecznej
 ...
 - punkt wy??czenia wody grzewczej dla grzania wody u?ytkowej >=91°, punkt za??czenia wody grzewczej dla grzania wody u?ytkowej <=87									 - punkt wy??czenia wody grzewczej = [nastawa +10°] ale nie wi?cej ni? [maksymalna wartoœ? nastawy +5°] 
...
Wersja 6 (28.09.2015)
 ...
 - dodano komendy zdalnego sterowania z magistrali LIN (mozliwoœ? zmiany parametrow pracy)
