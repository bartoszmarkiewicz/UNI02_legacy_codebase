...
#define _TDPR1 6			//[s] czas zwloki na za?aczenie czujnika przeplywu WG (po czasie staly kod 05)
...
#define _TCPRO 6			//[s] czas do awaryjnego wylaczenia od uszkodzonego czujnika przeplywu WG (zalaczony mimo wylaczonej pompy (po czasie migajacy kod 05)
