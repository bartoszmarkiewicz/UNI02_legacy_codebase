...
/*---------------------------------------------------------------------------------*/
#define _ENRDTONL 1			//zal/wyl proc ReadDataONL(...)
...
/*---------------------------------------------------------------------------------*/
#define _ENRDTOXL 1			//zal/wyl proc ReadDataXONL(...)
...
//keypad.c
	...
	extern unsigned char ExPresKey2B(unsigned char k,unsigned char dTim,unsigned char pTim);
//rtimer.c	
