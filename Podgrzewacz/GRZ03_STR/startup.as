	...
	; bit.obj i2c_s.obj isr.obj keypad.obj main.obj osc.obj pomiar.obj \
	; port.obj print.obj pwm.obj pwron.obj rgl.obj rtimer.obj timer1.obj \
	; readdtal.obj konfig.obj mux.obj wsw2.obj --chip=18F46K20 -P \
...
; clearing bss, rbit psect - 274 bytes to clear
GLOBAL	__Lrbit
	lfsr	0,(__Lrbit)/8
	lfsr	1,274	; loop variable
...
; clearing rbss psect - 62 bytes to clear
GLOBAL	__Lrbss
	lfsr	0,__Lrbss
	movlw	62	; loop counter
clear_rbss_psect:
	clrf	postinc0	; clear, increment FSR0
	decf	wreg	; decrement loop counter
	bnz	clear_rbss_psect

; clearing bigbss psect - 89 bytes to clear
GLOBAL	__Lbigbss
	lfsr	0,__Lbigbss
	movlw	89	; loop counter
clear_bigbss_psect:
	clrf	postinc0	; clear, increment FSR0
	decf	wreg	; decrement loop counter
	bnz	clear_bigbss_psect

; bigdata psect - 8 bytes to load
GLOBAL	__Lbigdata,__Libigdata
	lfsr	0,__Lbigdata
	; load TBLPTR registers with __Libigdata (10A2h)
	movlw	low (__Libigdata)
	movwf	tblptrl
	movlw	low (__Libigdata/100h)
	movwf	tblptrh
	lfsr	1,8	; loop variable
