...
#define _VLO_PWM1		31//31		//wypelnienie ponizej ktorego wentylator nie pracuje NG40 (dla 1kHz 14 = 440 obr/min)
#define _VLO_PWM2		26//29		//wypelnienie ponizej ktorego wentylator nie pracuje NG31 (26 - podtrzymanie 970 obr/min, 29 - uruchomirnie 1140 obr/min )
#else           //1kHz
#define _VLO_PWM0		18//18		    //wypelnienie ponizej ktorego wentylator nie pracuje FIME
#define _VLO_PWM1		31//31		//wypelnienie ponizej ktorego wentylator nie pracuje NG40 (dla 1kHz 14 = 440 obr/min)
#define _VLO_PWM2		21//29		//wypelnienie ponizej ktorego wentylator nie pracuje NG31(20 1000)
#endif
...
//----------------------------------------------------------
	void SetOsc(void);
	extern unsigned char CalkVNTtoPWM(unsigned char nst);
