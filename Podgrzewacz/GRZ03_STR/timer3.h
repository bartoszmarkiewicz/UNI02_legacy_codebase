...
#define _PRE3 8					//8 prescaler (1,2,4,8)
#define _PDZ3 4					//4 dzielnik interwalu czasu _TIM3
#define _POPR3 -90				//-90wartosc poprawki
#else
#define _TIM3 1					//1oczekiwany kwant czasu [mS]              //1
#define _PRE3 1					//1 prescaler (1,2,4,8)                     //8
#define _PDZ3 8					//8 dzielnik interwalu czasu _TIM3          //2
#define _POPR3 95				//95wartosc poprawki                        //95
#endif
