...
//----------------------------------------------------------
typedef struct	{
				unsigned _pob_KCO;			//znacznik pobudzenia CO z procedury konfiguracji
				unsigned _pob_KCW;			//znacznik pobudzenia CW z procedury konfiguracji
				unsigned _pob_KAL;			//znacznik pobudzenia CW od funkcji AL z procedury konfiguracji
				unsigned _pob_SRW;			//znacznik pobudzenia z procedury serwisowej
				unsigned _pob_CW;			//znacznik pobudzenia CW
				unsigned _pob_CO;			//znacznik pobudzenia CO 
				unsigned _pob_DzCO;			//znacznik pobudzenia od temperatury dyzurnej CO
				unsigned _pob_DzCW;			//znacznik pobudzenia od temperatury dyzurnej CW
				...
				unsigned _AKTYWNE_SRW;		//znacznik aktywnosci funkcji serwisowej
				unsigned _AKTYWNE_PGD;		//znacznik aktywnosci funkcji pogodowej
				unsigned _AKTYWNE_KNF;		//znacznik aktywnosci procedury konfiguracji
			...
			//	unsigned _RPM_CW:1;			//znacznik pracy w obiegu CW dla kotla monotermicznego
				...
				unsigned _min_SRW:1;        //znacznik pracy na minimum w trakcie trwania funkcji serwisowej
