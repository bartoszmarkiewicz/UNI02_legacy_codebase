...
typedef struct	{
        ...
        union   {
            ...
            struct
            {                               
				unsigned _SVWB:1;           //wybieg wentylatora na mocy startowej
				unsigned _initVNT:1;							
				unsigned _blkDzCW:1;        //blokada dla temp.dyzurnej CW			
				unsigned _fl5bt3:1;			
				unsigned _fl5bt4:1;		
				unsigned _fl5bt5:1;		
				unsigned _fl5bt6:1;			
                ...
                unsigned char I2CVNT;       //predkosc obrotowa dla celow I2C
