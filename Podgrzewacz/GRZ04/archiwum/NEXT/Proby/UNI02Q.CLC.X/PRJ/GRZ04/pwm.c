...
{          
    ...
    //pw3=VNTtoVPROC(); rzeczywista predkosc wentylatora wyrazona w procentach
        ...
        */
            ...
            //if(!M._ROZRUCH||(M._ROZRUCH&&M._initVNT))
        {
            ...
            */
            ...
            prc=(float)VNTtoPPWM(_INITVNT)/99.0;         //30 oczekiwana predkosc wentylatora na procent wypelnienia na wentylatorze
            vpwm=((float)PWM.HIPWM3)*prc;
            WritePWM3H((unsigned int)vpwm);
            pw2=VNTtoPPWM(_INITVNT);            
            pw1=0;
            StartPID(1); 
        }
        else   
