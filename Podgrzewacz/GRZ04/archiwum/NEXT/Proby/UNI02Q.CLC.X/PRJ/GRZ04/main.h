...
#define _TITPL 2			//2[s] okres czasu gdy ignorowany jest syg. plomien
#define _TDTPL 7			//[s] czas na stwierdzenie obecnosci plonienia

#define _TDWPL 3			//3 [s] wybieg na mocy startowej (modulator/wentylator) w proc. rozruchu
#define _TDZCW 5			//5 [s] wybieg na mocy startowej dla temp. dyzurnej
#define _TDZBLK 15			//5 [m] czas blokady dla dla temp. dyzurnej
#define _TVSTRT 6           //3 [s] przedluzony wybieg na mocy startowej (wentylator)
