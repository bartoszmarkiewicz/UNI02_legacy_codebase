...
#define _GRZ04 6		//grzejnik WU

/*---------------------------------------------------------------------------------*/
#define _TYPKT _GRZ04	//aktualnie wybrana konfiguracja domyslna dla kompilacji
/*---------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------*/
...
#define	_KMAXMNV 25         //99
#define	_KMINMXV 10			//5  maksimum predkosci wentylatora
#define	_KMAXMXV 50         //99
#define	_KMINMSV 10			//10  predkosc startowa
#define	_KMAXMSV 50         //50
#define	_KMINLKM 1			//dlugosc komina
#define	_KMAXLKM 8
