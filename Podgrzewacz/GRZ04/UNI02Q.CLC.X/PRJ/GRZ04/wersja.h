...
- optymalizacja procedury startowej dla gazow plynnych (wybiegi na mocy startowej)
 ...
 Wersja 3
(10.03.2022)
- wprowadzane kolejne wartosci tabel
- obnizona wartosc czasowego podniesienia mocy minimalnej po rozruchu
- obnizona wartosc predkosci wentylatora po rozruchu w trakcie czasu podtrzymanaia stalej predkosci
(29.03.2022)
- modyfikacje wartosci w tabelach
- nowa procedura serwisowa
- nowe wpisy tabeli dla mocy startowej propan-butan, podgrzewacz niskiej mocy 
(30.03.2022)
- modyfikacja wartosci w tabelach mocy startowej
- usuniete wzbudzenie wentylatora po wyjsciu z wybiegu na mocy startowej
(04.04.2022)
- weryfikacja zapisów we wszystkich tabelach
(14.04.2022)
- poprawione warto?ci domy?lnie programowane produkcyjnie (r1,r6)
*/
//----------------------------------------------------------
