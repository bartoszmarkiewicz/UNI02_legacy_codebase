...
#define _DTLKM	8           //dlugosc komina
...
#endif
#if _DTLKM==4
#define _DTASTV 18          //22startowe PWM na wentylatorze
#define _DTAMST	17			//moc startowa
#endif
#if _DTLKM==5
#define _DTASTV 15          //22startowe PWM na wentylatorze
#define _DTAMST	19			//moc startowa
#endif
#if _DTLKM==6
#define _DTASTV 13          //22startowe PWM na wentylatorze
#define _DTAMST	19			//moc startowa
#endif
#if _DTLKM==7
#define _DTASTV 13          //22startowe PWM na wentylatorze
