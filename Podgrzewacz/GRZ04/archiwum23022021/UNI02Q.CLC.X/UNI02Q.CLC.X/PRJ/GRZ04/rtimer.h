...
#define	_NRT_dS	16		/*liczba timerow typu dS*/
#define _NRT_S	15		/*liczba timerow typu S*/
#define _NRT_M	6		/*liczba timerow typu M*/
#define _NRT_G	2		/*liczba timerow typu G*/
