			...
			switch(DtKNF.PRM)
			{
				...
				case 3:
				{
					...
					else 
					{
                        ...
                        {
                            DtKNF.mstr=GetModSTR(DtKNF.rdgz,DtKNF.lkm,DtKNF.pwr);
                            DtKNF.strv=GetVntSTR(DtKNF.rdgz,DtKNF.lkm,DtKNF.pwr);
                            if_WriteEEPROM(_ADRMST,DtKNF.mstr);
				...
				case 7:
				{
					...
					{
                        if(DtKNF.lkm!=ReadEEPROM(_ADRLKM))
                        {
                            DtKNF.mstr=GetModSTR(DtKNF.rdgz,DtKNF.lkm,DtKNF.pwr);
                            DtKNF.strv=GetVntSTR(DtKNF.rdgz,DtKNF.lkm,DtKNF.pwr);
                            if_WriteEEPROM(_ADRMST,DtKNF.mstr);
				...
				case 8:
				{
					...
					{
                        if(DtKNF.pwr!=ReadEEPROM(_ADRPWR))
                        {
                            DtKNF.mstr=GetModSTR(DtKNF.rdgz,DtKNF.lkm,DtKNF.pwr);
                            DtKNF.strv=GetVntSTR(DtKNF.rdgz,DtKNF.lkm,DtKNF.pwr);
                            if_WriteEEPROM(_ADRMST,DtKNF.mstr);
