...
#define _TDPR1 3			//3[s] czas zwloki na zalaczenie czujnika przeplywu WG (po czasie staly kod 05)
...
#else
#define _TWBCO 10			//[s] czas wybiegu pompy po grzaniu w obiegu CO
#endif
