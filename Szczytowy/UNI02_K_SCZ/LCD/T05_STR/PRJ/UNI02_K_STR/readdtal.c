...
#if (_ENRDTONL)
unsigned char ReadDataONL(unsigned char k,volatile unsigned char *dt,unsigned char min,unsigned char max,const unsigned char step,unsigned char wrn)
{
	if(*dt<min) *dt=min;
...
#if (_ENRDTOXL)
unsigned char ReadDataXONL(unsigned char k,volatile unsigned char *dt,unsigned char min,unsigned char max,const unsigned char step,const unsigned char step2,unsigned char wrn)
{
	static bit dtmo=0;
...
#if (_ENRDTOXLID)
//INKREMENTACJA
unsigned char ReadDataXONLI(unsigned char k,volatile unsigned char *dt,unsigned char max,const unsigned char step,const unsigned char step2)
{
	static bit dtmo=0;
	static unsigned char ktu,iu;
	char key=0;
...
//DEKREMENTACJA
unsigned char ReadDataXONLD(unsigned char k,volatile unsigned char *dt,unsigned char min,const unsigned char step,const unsigned char step2)
{
	static bit dtmo=0;
	static unsigned char ktu,iu;
	char key=0;
