...
typedef struct	{
        ...
        union   {
            ...
            {                
				unsigned _fpCO:1;
                unsigned _wrtPCO:1;         //flaga zapisu nastawy PCO
                unsigned _wrtMXCO:1;        //flaga zapisu nastawy MXCO
                unsigned _newMXCO:1;		//nastapila zmana pozycji potencjometru MXCO w zakresie nastawy.
                unsigned _fl2bt4:1;			//
                unsigned _fl2bt5:1;			//
                unsigned _fl2bt6:1;			//
                unsigned _fl2bt7:1;			//                
				...
				unsigned char MXCO;		//nastawa ogranicznika mocy                 
				unsigned char minMXCO;	//minimalna wartosc nastawy MXCO
				unsigned char maxMXCO;	//maksymalna wartosc nastawy MXCO
...
typedef struct	{
        union   {
            ...
            struct
            {
                ...
                unsigned _hot_IN:1;		//wysoka temperatura na powrocie obiegu CO $$$
                unsigned _fl0bt3:1;			//                
                unsigned _fl0bt4:1;			//
                unsigned _fl0bt5:1;			//
                unsigned _fl0bt6:1;			//
