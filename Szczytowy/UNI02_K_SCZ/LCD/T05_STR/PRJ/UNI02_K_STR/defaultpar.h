...
#define _ADRMXCO  0x01D0        //manualna nastawa mocy kotla
...
//----------
#define _DPWMPMP 0			//1 ! domyslny typ pompy (1-PWM) **************
#define _DPRFAN 0			// ! domyslny typ wentylatora (0-FIME,1-NG40,2-fabryczny)

//#define _DTPGDR 0               //rodzaj regulatora pogodowego
...
#define _DEFPWTM 5              //maksimum przewyzszenia temperaturowego     
//---------
...
//Kotly jednofunkcyjne
    ...
    #define _DEFMXCO  _DTAMCO   //manualna nastawa mocy kotla
	#define _DTAPDG	1			//1 ogrzewanie podlogowe
	...
	#define _DTATAL	1			//aktywacja timera AntyLegionella
	#define _DTARTA	0			//wartosc poczatkowa timera AntyLegionella
	#define _DTAOBG	0			//domyslny obieg otwarty (dot. UniCo
	...
	#define _DTTSTR	2          //czas wybiegu na mocy startowej (tryb pracy CO)
