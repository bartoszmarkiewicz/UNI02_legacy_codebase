...
//#define _ON_CO1 (unsigned int)(9.3808*_ON_LTR - 1.4553)			//liczba imp/sek ustawiajaca CW
//#define _OFF_CO1 (unsigned int)(9.3808*_OFF_LTR - 1.4553)			//liczba imp/sek wylaczajaca CW

#define _ONE1 (unsigned int)(3.0*_LTR)			//liczba imp/sek ustawiajaca CW
#define _ON_CO1 (unsigned int)(3.0*_ON_LTR)			//liczba imp/sek ustawiajaca CW
#define _OFF_CO1 (unsigned int)(3.0*_OFF_LTR)			//liczba imp/sek wylaczajaca CW
