...
//--------------------------------------------------------------
//--------------------------------------------------------------
#define _DEMO 0             //tryb demonstracyjny pracy sterownika
#define _DEMO_NZW 1         //wylaczenie symulacji czujnika zewnetrznego w trybie DEMO

#define _TSPRZ_CO 0         //wyswietlanie testowe stanu przetwornika przeplywu CO na I2C

//--------------------------------------------------------------
#define _ZR_SCZ 1           //konfiguracja na zrodlo szczytowe
#define _NST_P3 1            //sterowanie z nastawa mocy maksymalnej
//Wykluczenia procedur

#define _NO_PO 1            //wylaczenie procedury odpowietrzajace
#define _NO_BLOK15S 1       //wylaczenie blokady 15S po pracy na obieg CW
#define _NO_PRC_PMP 1       //wylaczenie procedur zwiazanych z rozruchem pompy
#define _NO_SYM_PRZ 0       //wylaczenie symulacji przeplywu wody grzewczej (w trybie DEMO)

//--------------------------------------------------------------
//UART - Dane zwiazane z komunikacja RS232 z modulem LCD
#define _MY_ADDR	0x11            //adres wlasny plytki sterujacej UNI-02 do kotlow szczytowych
#define _LCD_ADDR	0x12            //adres modulu LCD do kotlow szczytowych
//-------------------
...
#define _RTDCO 17
#define _RTDCW 18
#define _RTKEY2	19			//keypad.c - timer konsoli
//**************************************************************
//RTS
...
#define _RTSPRZ 17          //nain.c - zegar symulacji przeplywu CO (na potrzeby trybu DEMO)
//*************************************************************
//RTM
...
#define S_HOT_IN    24		//2/10 $$$
#define S_KDW		25		//1/1	
#define S_KUP		26		//1/1
#define S_UP_TMP	27		//20/20
...
#define _LN_UP 7        //pobudzenie grzania na wysokich parametrach
