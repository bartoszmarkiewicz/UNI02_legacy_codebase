...
#define _NDT_RRD_STD 23     //16Dane tablicowe

#define _CLIN_RRD_STD2      0x03 //IDN - zadanie wysylki paczki standard do KSK
#define _NDT_RRD_STD2 23     //22Dane tablicowe
...
#define _CLIN_RRD_SETPP     0x40    //IDN - informacja zwrotna pobudzen i wartosci oczekiwanych (na potrzeby BYPASS)
...
extern unsigned char ChkAvailablePar(const unsigned char nr);
