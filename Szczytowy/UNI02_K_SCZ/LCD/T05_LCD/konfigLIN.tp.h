...
typedef struct	{
    union   {
      ...
      struct //__PACKED
      {
         unsigned _keyUP:1;     //ustawienie flagi oczekiwania na puszczenie przycisku UP            
         unsigned _keySET:1;	//ustawienie flagi oczekiwania na puszczenie przycisku SET                      
         unsigned _keyOFF:1;    //ustawienie flagi oczekiwania na puszczenie przycisku OFF                       
         unsigned fl0bt3:1;		//                       
         unsigned fl0bt4:1;		//                        
         unsigned fl0bt5:1;		//                        
         unsigned fl0bt6:1;		//     
