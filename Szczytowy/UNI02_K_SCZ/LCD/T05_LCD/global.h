...
#endif
#if _KEY_BBOARD!=0
#error Wsparcie tylko dla plytki 4key!
#endif

#if _EXT_BOARD!=3
#error Wsparcie tylko dla plytki najnowszeego typu!
#endif
//--------------------------------------------------------------
//--------------------------------------------------------------
...
#endif
#endif
#define _LIN_OID        0x03                //0x01 identyfikator kotla szczytowego
//--------------------------------------------------------------
//--------------------------------------------------------------
...
#define _TEST_UP    0       //test pobudzenia na parametrach wysokich
#define _TEST_DW    0       //test pobudzenia na parametrach wysokich
//--------------------------------------------------------------
...
#define _MY_ADDR	0x12	//0x11 adres wlasny plytki wyswietlacza kotla szczytowego
#define _UNI02_ADDR	0x11	//0x10 adres plytki steruj¹cej kotla szczytowego
//--------------------------------------------------------------------------
//RTcS
...
#define _RTPLIN   7            //60timer dla  zdalnych parametrow (status)
#define _RTPLIN2  8            //61timer dla  zdalnych parametrow (pobudzenia stref)
#define _RTLKONFI 9			//konfigLN.c - timer konfiguracji  //kkk

//RTM
#define _RTKONF3 0			//konfig.c - timer aktywnosci konfiguracji
#define _RTFSR	 1			//konsola.c
#define _RTALG	 2			//konsola.c
#define _RTLKONF 3			//konfigLN.c - timer aktywnosci konfiguracji  //kkk
...
//--------------------------------------------------------------------------
    ...
    #define SS_OFF_SET_KUP	5		//WE        //kkk
#endif
#if _KEY_BBOARD==1
    #define S_OFF			0		//WE
    #define S_SET			1		//WE
    ...
    #define SS_OFF_SET_KUP	8		//WE        //kkk
#endif
//--------------------------------------------------------------
//---------------------------------------------------------------
