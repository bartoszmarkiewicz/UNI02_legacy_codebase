...
#define _TSTRNST 30			//[ds] czas podtrzymania nastawy rozruchu
//----------------------------------------------------------
//----------------------------------------------------------
//----------------------------------------------------------
...
//wsw.c
    ...
    extern unsigned char GetPoz(const unsigned char nrkol,const unsigned char nrpoz);   //mmm
//pwm2.c
...
//print.c
	...
	extern void ClrDig(const unsigned char dhigh, const unsigned char dlow, const unsigned char krs);
        ...
        extern void PrintCo(const unsigned char tm, const unsigned char err);        
        ...
        extern void PrintNstMXCO(const unsigned char nst,const unsigned char only);
        extern void PrintSRV(const unsigned char vn, const unsigned char tm, const unsigned char err);
        extern void PrintGCO(const unsigned char vn, const unsigned char tm, const unsigned char up, const unsigned char err);      
        extern void PrintFL(unsigned char pp);
//bit.c
...
//ot.c
        ...
        extern unsigned char *GetKolBufSTD(void);        
        
        extern void LIN2SClrMasterIDO(void);    
//konfigLN.c        
    extern void InitKonfLIN(void);      //kkk
    extern void LKonfiguracja(void);    //kkk        
//----------------------------------------------------------
#endif		/*_MAIN_H*/
