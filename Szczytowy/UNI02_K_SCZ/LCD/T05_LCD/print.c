...
//lkod - dowolny znak w kodzie led wyswietlany na 3 cyfrze
//nkod - liczba zakresu 0-99 wyswietlana na 2 najmlodszych cyfrach
//dla tryb=0 lkod wyswietlany pojedynczo
//dla tryb=1 lkod wyswietlany podwojnie
void PrintPR2(const unsigned char lkod,unsigned char nkod,unsigned char tryb)   //kkk
{
#if LCD4D==0
	if((nkod>0xf)&&!tryb) nkod=0xf;
	SetData(&(PWD[_WS_PRM].Dt),lkod,(!tryb)?Znak[nkod]:nkod);
    ...
    {
        SetData(&(PWD[_WS_PRM].Dt2),lkod,lkod);
    }
	SetStatus(&(PWD[_WS_PRM].St2),tLED|tFOCUS,tALL,0,0);
	SetData(&(PWD[_WS_PRM].Dt),0,nkod);
	SetStatus(&(PWD[_WS_PRM].St),tDEC|tSDID|tFOCUS,tALL,_KZ_SRV,0);
...
void PrintNoPP(void)        //kkk
{
	...
	SetStatus(&(PWD[_WS_PRM].St),tLED|tSDID|tFOCUS,tALL,_KZ_SRV,0);
#else
	SetData(&(PWD[_WS_PRM].Dt2),led_n,led_o);
	SetStatus(&(PWD[_WS_PRM].St2),tLED|tRDID|tFOCUS,tALL,0,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
	SetData(&(PWD[_WS_PRM].Dt),led_P,led_P);
	SetStatus(&(PWD[_WS_PRM].St),tLED|tRDID|tSDID|tFOCUS,tALL,_KZ_SRV,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
#endif
	//UpdateWSW();
}
//----------
...
//---------------------------------------------------------
//wyswietla wartosc parametru
void PrintWPR2(signed int dt,unsigned char fl)      //kkk
{
    FlPZK stat;
    signed int dtt;
    unsigned int fm;
    ...
    dtt=dt;
    stat.fl.war=fl;
    fm=(stat.fl.flt)?tKROPKA1:0;//((!stat.fl.high)?tKROPKA0:tKROPKA1):0;
    if(!stat.fl.high)
    {
        if(dtt>=0)
        {
            ...
            {
                SetStatus(&(PWD[_WS_PRM].St2),tLED|tFOCUS,tALL,0,0);  
                SetData(&(PWD[_WS_PRM].Dt2),BLACK,BLACK);       
                if(dtt>9)
                {
                    SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0); 
                    SetData(&(PWD[_WS_PRM].Dt),0,dtt);
                ...
                {                    
                    if(!stat.fl.flt)
                    {
                        SetStatus(&(PWD[_WS_PRM].St),tLED|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0);
                        SetData(&(PWD[_WS_PRM].Dt),BLACK,Znak[dtt]);  
                    }
                    else
                    {
                        SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0); 
            ...
            {
                if(dtt>9999) dtt=9999;
                if(dtt<=999)
                {
                    SetStatus(&(PWD[_WS_PRM].St2),tLED|tFOCUS,tALL,0,0);
                    SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0);
                    SetData(&(PWD[_WS_PRM].Dt2),BLACK,Znak[dtt/100]);
                    SetData(&(PWD[_WS_PRM].Dt),0,dtt%100);
                ...
                else
                {
                    SetStatus(&(PWD[_WS_PRM].St2),tDEC|tFOCUS,tALL,0,0);
                    SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0); 
                    SetData(&(PWD[_WS_PRM].Dt2),0,dtt/100);
                    SetData(&(PWD[_WS_PRM].Dt),0,dtt%100);                  
                }
            }
        }
        else
        {
            ...
            if(dtt<=99)
            {
                ...
                {
                    SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0); 
                    SetData(&(PWD[_WS_PRM].Dt2),BLACK,KRESKA); 
                    SetData(&(PWD[_WS_PRM].Dt),0,dtt);
                }
                else
                {                    
                    if(!stat.fl.flt)
                    {
                        SetStatus(&(PWD[_WS_PRM].St),tLED|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0);
                        SetData(&(PWD[_WS_PRM].Dt2),BLACK,BLACK); 
                        SetData(&(PWD[_WS_PRM].Dt),KRESKA,Znak[dtt]);  
                    }
                    else
                    {
                        SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0);
            ...
            {
                SetStatus(&(PWD[_WS_PRM].St),tDEC|fm|tSDID|tFOCUS,tALL,_KZ_SRV,0);
                SetData(&(PWD[_WS_PRM].Dt2),KRESKA,Znak[dtt/100]);
                SetData(&(PWD[_WS_PRM].Dt),0,dtt%100);
            }               
        }
    }
    else
    {
        ...
        {
            if(dtt>99) dtt=99;
            SetData(&(PWD[_WS_PRM].Dt2),0,dtt);
            SetStatus(&(PWD[_WS_PRM].St2),tDEC|fm|tFOCUS,tALL,0,0);
            SetData(&(PWD[_WS_PRM].Dt),0,0);
            SetStatus(&(PWD[_WS_PRM].St),tDEC|tSDID|tFOCUS,tALL,_KZ_SRV,0);             
        }
        else
        {
            if(dtt<-9) dtt=-9;
            dtt=-1*dtt;
            SetData(&(PWD[_WS_PRM].Dt2),KRESKA,Znak[dtt]);
            SetStatus(&(PWD[_WS_PRM].St2),tLED|fm|tFOCUS,tALL,0,0);
            SetData(&(PWD[_WS_PRM].Dt),0,0);
            SetStatus(&(PWD[_WS_PRM].St),tDEC|tSDID|tFOCUS,tALL,_KZ_SRV,0);                
        }
    }
...
//---------------------------------------------------------
//---------------------------------------------------------
void PrintKrs(void)     //kkk
{
	SetData(&(DWD[0].Dt2),KRESKA,KRESKA);		//kod E
	SetData(&(DWD[0].Dt),KRESKA,KRESKA);			//nr bledu
   
	SetStatus(&(DWD[0].St2),tLED|tRDID|tSDID|tFOCUS,tALL,_KZ_SRV,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
	SetStatus(&(DWD[0].St),tLED|tRDID|tSDID|tFOCUS,tALL,_KZ_SRV,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
     
	SetData(&(DWD[1].Dt2),led__,led__);		//kod E
	SetData(&(DWD[1].Dt),led__,led__);			//nr bledu
       
	SetStatus(&(DWD[1].St2),tLED|tRDID|tSDID|tFOCUS,tALL,_KZ_SRV,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
	SetStatus(&(DWD[1].St),tLED|tRDID|tSDID|tFOCUS,tALL,_KZ_SRV,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);    
	SetPoz(_WS_ERR,0);
	SetPoz(_WS_ERR,1);
}
void EndKrs(void)
...
void PrintNstCW(const unsigned char nst,const unsigned char only)
{
	...
	fl=(!only)?0:tONL;
    //fl=tONL;
	SetData(&(DWD[2].Dt),0,nst);							//nastawa CW
	SetData(&(DWD[3].Dt),BLACK,BLACK);
	SetStatus(&(DWD[2].St),fl|tDEC|tSDID|tFOCUS,tALL,_KZ_TCO|_KZ_DCW|_KZ_DCO,0);
	SetStatus(&(DWD[3].St),fl|tLED|tRDID,tALL,0,_KZ_PGD|_KZ_BAR|_KZ_TCO|_KZ_TCW|_KZ_DCW|_KZ_DCO);
	MarkMinMax(1,0);
//#if LCD4D!=0
//	if(!only)
//	{
    SetStatus(&(DWD[2].St2),tWYGAS|tRDID,tALL,0,_KZ_PGD|_KZ_TCW|_KZ_BAR);
    SetStatus(&(DWD[3].St2),tWYGAS|tRDID,tALL,0,_KZ_PGD|_KZ_TCW|_KZ_BAR);
//	}
//#endif
	RestartKol1(_KL_NCWCO);
}
...
void PrintNstCW2(const unsigned char nst,const unsigned char min, const unsigned char only)
{
	...
	if(nst>min)
	{
		...
		SetData(&(DWD[3].Dt),BLACK,BLACK);
		SetStatus(&(DWD[2].St),fl|tDEC|tSDID|tFOCUS,tALL,_KZ_TCO|_KZ_DCW|_KZ_DCO,0);
		SetStatus(&(DWD[3].St),fl|tLED|tRDID,tALL,0,_KZ_PGD|_KZ_BAR|_KZ_TCO|_KZ_DCW|_KZ_DCO);
		MarkMinMax(1,0);
	}
	else
	{
		SetData(&(DWD[2].Dt),KRESKA,KRESKA);							//nastawa CW
		SetData(&(DWD[3].Dt),BLACK,BLACK);
		SetStatus(&(DWD[2].St),fl|tLED|tSDID|tRDID|tFOCUS,tALL,_KZ_TCO|_KZ_DCW|_KZ_DCO,0);
		SetStatus(&(DWD[3].St),fl|tLED|tSDID|tRDID,tALL,0,_KZ_PGD|_KZ_BAR|_KZ_TCO|_KZ_DCW|_KZ_DCO);
		ClrMarkMinMax();
	}
//#if LCD4D!=0
//	if(!only)
...
void PrintNstCO(const unsigned char nst,const unsigned char kt,const unsigned char only)
{
	...
	SetData(&(DWD[3].Dt),BLACK,BLACK);						//wygaszenie
	SetStatus(&(DWD[2].St),fl|fk|tDEC|tSDID|tRDID|tFOCUS,tALL,fm|_KZ_DCO,fn|_KZ_BAR);
	SetStatus(&(DWD[3].St),fl|tLED|tRDID,tALL,0,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_DCO|_KZ_BAR);
	MarkMinMax(0,1);
//#if LCD4D!=0
//	if(!only)
//	{	
...
void PrintNstMXCO(const unsigned char nst,const unsigned char only)
{
	unsigned int fl;
	fl=(!only)?0:tONL;
	SetData(&(DWD[2].Dt2),0,nst);							//nastawa CW
	SetData(&(DWD[3].Dt2),BLACK,BLACK);
	SetStatus(&(DWD[2].St2),fl|tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_DCO,_KZ_DCW|_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
	SetStatus(&(DWD[3].St2),fl|tLED|tRDID,tALL,0,_KZ_DCW|_KZ_DCO|_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
	MarkMinMax(1,0);
#if LCD4D!=0
//	if(!only)
//	{
    SetStatus(&(DWD[2].St),tWYGAS|tRDID,tALL,0,_KZ_DCW|_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
    SetStatus(&(DWD[3].St),tWYGAS|tRDID,tALL,0,_KZ_DCW|_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
//	}
#endif
	RestartKol1(_KL_NCWCO);
}
...
void PrintCW(const unsigned char tm,const unsigned char only)
{
	...
	SetData(&(PWD[_WS_TCW].Dt),0,tm);						//tempetratura CW
#else
	SetStatus(&(PWD[_WS_TCW].St),fl|tDEC|tSDID|tFOCUS,tALL,_KZ_TCO,_KZ_BAR);//|_KZ_DCW,0);
	SetData(&(PWD[_WS_TCW].Dt),0,tm);						//tempetratura CW
	if(!only) SetStatus(&(PWD[_WS_TCW].St2),tWYGAS|tFOCUS,tALL,0,0);
#endif
	//UpdateWSW();
}
//---------------------------------------------------------
...
void PrintSRV(const unsigned char vn, const unsigned char tm, const unsigned char err)
{
    ...
    if(!err)
    {
        SetStatus(&(PWD[_WS_TCW].St),tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_TCO|_KZ_DCO,_KZ_TCW|_KZ_DCW|_KZ_PGD|_KZ_BAR);
        SetData(&(PWD[_WS_TCW].Dt),0,tm);												//tempetratura CO
    }
    else
    {
        SetStatus(&(PWD[_WS_TCW].St),tLED|tSDID|tRDID|tFOCUS,tALL,_KZ_DCO,_KZ_TCO|_KZ_TCW|_KZ_DCW|_KZ_PGD|_KZ_BAR);
        SetData(&(PWD[_WS_TCW].Dt),KRESKA,KRESKA);												//tempetratura CO
    }  
	SetStatus(&(PWD[_WS_TCW].St2),tDEC|tRDID|tFOCUS,tALL,0,_KZ_TCW|_KZ_DCW|_KZ_PGD|_KZ_BAR);
	SetData(&(PWD[_WS_TCW].Dt2),0,vn);						//tempetratura CW
#endif
}

void PrintGCO(const unsigned char vn, const unsigned char tm, const unsigned char up, const unsigned char err)
{
    //unsigned int fl;
#if LCD4D==0
	SetStatus(&(PWD[_WS_TCW].St),tDEC|tRDID|tFOCUS,tALL,0,_KZ_TCW);//|_KZ_DCW,0);
    ...
    if(!up)
    {
        if(!err)
        {
            SetStatus(&(PWD[_WS_TCO].St),tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_TCO|_KZ_DCO,_KZ_TCW|_KZ_DCW|_KZ_PGD|_KZ_BAR);
            SetData(&(PWD[_WS_TCO].Dt),0,tm);												//tempetratura CO
        }
        else
        {
            SetStatus(&(PWD[_WS_TCO].St),tLED|tSDID|tRDID|tFOCUS,tALL,_KZ_DCO,_KZ_TCO|_KZ_TCW|_KZ_DCW|_KZ_PGD|_KZ_BAR);
            SetData(&(PWD[_WS_TCO].Dt),KRESKA,KRESKA);												//tempetratura CO
        }  
        SetStatus(&(PWD[_WS_TCO].St2),tDEC|tRDID|tFOCUS,tALL,0,_KZ_TCW|_KZ_DCW|_KZ_PGD|_KZ_BAR);
        SetData(&(PWD[_WS_TCO].Dt2),0,vn);						//tempetratura CW
    }
    else
    {
        if(!err)
        {
            SetStatus(&(PWD[_WS_TCO].St),tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_DCW|_KZ_TCO|_KZ_DCO,_KZ_TCW|_KZ_PGD|_KZ_BAR);
            SetData(&(PWD[_WS_TCO].Dt),0,tm);												//tempetratura CO
        }
        else
        {
            SetStatus(&(PWD[_WS_TCO].St),tLED|tSDID|tRDID|tFOCUS,tALL,_KZ_DCW|_KZ_DCO,_KZ_TCO|_KZ_TCW|_KZ_PGD|_KZ_BAR);
            SetData(&(PWD[_WS_TCO].Dt),KRESKA,KRESKA);												//tempetratura CO
        }  
        SetStatus(&(PWD[_WS_TCO].St2),tDEC|tRDID|tFOCUS,tALL,0,_KZ_TCW|_KZ_PGD|_KZ_BAR);
        SetData(&(PWD[_WS_TCO].Dt2),0,vn);						//tempetratura CW        
    }        
#endif
}
...
#else
	SetStatus(&(PWD[_WS_TCW].St2),tLED|tRDID|tFOCUS,tALL,0,_KZ_TCW);
	SetData(&(PWD[_WS_TCW].Dt2),led_F,led_r);						
	SetStatus(&(PWD[_WS_TCO].St),tDEC|tRDID|tFOCUS,tALL,0,_KZ_BAR|_KZ_TCO);	
	SetData(&(PWD[_WS_TCO].Dt),0,pg);
#endif
}

//void PrintFL(unsigned char pp)
//{
//	if(pp>99) pp=99;
//#if LCD4D==0
//	SetStatus(&(PWD[_WS_TCO].St),tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_TCO,_KZ_BAR);
...
void PrintFL(unsigned char pp)
{
    ...
    if(pp<100)
    {
        SetStatus(&(PWD[_WS_TCO].St),tDEC|tKROPKA1|tRDID|tFOCUS,tALL,0,_KZ_BAR|_KZ_TCO);
        SetData(&(PWD[_WS_TCO].Dt),0,pp);
    }
    else
    {
        if(pp%10)
        {
            SetStatus(&(PWD[_WS_TCO].St),tDEC|tKROPKA0|tRDID|tFOCUS,tALL,0,_KZ_BAR|_KZ_TCO);
        }
        else
        {
            SetStatus(&(PWD[_WS_TCO].St),tDEC|tRDID|tFOCUS,tALL,0,_KZ_BAR|_KZ_TCO);
        }
        SetData(&(PWD[_WS_TCO].Dt),0,pp/10);
    }
...
void PrintCo(const unsigned char tm, const unsigned char err)
{
#if LCD4D==0
	SetStatus(&(PWD[_WS_TCO].St),tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_TCO,_KZ_BAR);
	SetData(&(PWD[_WS_TCO].Dt),0,tm);												//tempetratura IN
...
//---------------------------------------------------------
//wyswietla adres LIN
void PrintLN(const unsigned char laddr)     //kkk
{
#if LCD4D==0
	SetStatus(&(PWD[_WS_TCO].St),tDEC|tSDID|tRDID|tFOCUS,tALL,_KZ_TCO,_KZ_BAR);
	SetData(&(PWD[_WS_TCO].Dt),0,tm);												//tempetratura IN
#else
	SetStatus(&(PWD[_WS_TCW].St2),tLED|tRDID|tFOCUS,tALL,0,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);
	SetData(&(PWD[_WS_TCW].Dt2),led_L,led_n);
    if(laddr)
    {
        SetStatus(&(PWD[_WS_TCO].St),tDEC|tRDID|tFOCUS,tALL,0,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);	//tempetratura IN
        SetData(&(PWD[_WS_TCO].Dt),0,laddr);
    }
    else
    {
        SetStatus(&(PWD[_WS_TCO].St),tLED|tRDID|tFOCUS,tALL,0,_KZ_PGD|_KZ_TCO|_KZ_TCW|_KZ_BAR);	//tempetratura IN
        SetData(&(PWD[_WS_TCO].Dt),KRESKA,KRESKA);
    }
#endif
}
