            ...
            switch(krok)
            {
                ...
                case 1:         //1.Wysylka komendy do UNI-02
                {
                    ...
                    if(FRL1.WRD1.byte0<GetKNPAR())
                    {
                        ...
                        if(!ChkAvailablePar(RSDT1.inLDTA1)) //parametr dostepny?
                        {
                            krok=0;
                            return _LIN1_ERRODP;                            
                        }                        
...
unsigned char LIN1SingleResponse_RD(void)
{
    ...
    {      
        ...
        case _CLIN_RRD_LIFADDR:                 //nnn    
        {
            ...
            FTL1.WRD2.byte0=0x01;            //data2: aktualna konfiguracja sterownika (1F/2F)   
            ...
            dt=dt|(_KEY_BBOARD<<4);                             //(0-4 key, 1-7key, 2-Pot)
            FTL1.WRD2.byte1=dt;                                 //cztery m³odsze bity - identyfikator warstwy sprzetowej plyty sterujacej (1-p³ytka UNI-02)      
                                                                //cztery starsze bity - identyfikator warstwy sprzetowej p³ytki LCD (0-4 key, 1-7key, 2-Pot)
            break;
        }
...
//                } 
                FTL1.WRD1.byte0=FTL1.WRD1.byte0|0b10000000;                     //rodzaj danej (1F)
                //-----                
                FTL1.WRD1.byte1=(unsigned char)PFN.maxPCW;//RSDT1.outPCWmx;                         //gorna granica parametru          
                if(PFNf_plmCW)
                {
        ...
        case _CLIN_RRD_PCO:                 //wygeneruj wartosc PCO
        {
            if(!((FRL1.WRD1.byte0==0xAA)&&(FRL1.WRD1.byte1==0x55)))
            {
                ...
                FTL1.WRD2.byte0=0;                     //rodzaj danej (0-nastawa PCO, 1-wsp. KT) 
            }
            else
            {
                FTL1.PCI_LENGTH=0x06;                               //Rozmiar ramki(RSID+liczba bajtow danych bez CHK)
...
//                } 
        ...
        case _CLIN_RRD_TRB:                 
        {
            ...
            FTL1.WRD1.byte1=1;                                  //gorna granica parametru
            FTL1.WRD2.byte0=0;  
        ...
        case _CLIN_RRD_FSR:                //wygeneruj informacje o funkcji serwisowej 
        {
            ...
            else
            {
                ...
                //if(!PFNf_ferr&&!PFNf_fmsg&&!PFNf_fsetLaddr&&!PFNf_aktywne_KNF&&!PFNf_opgres&&PFNf_zima&&!PFNf_off&&!PFNf_aleg)    
...
//                        }
        ...
        case _CLIN_RRD_SETPP:                                   //informacja zwrotna pobudzen i wartosci oczekiwanych (na potrzeby BYPASS)  //jjj  //fff
        {
            FTL1.PCI_LENGTH=0x06;                               //Rozmiar ramki(RSID+liczba bajtow danych bez CHK)
            FTL1.WRD0.byte0=0xB2+0x40;                          //RSID=SID+0x40
            FTL1.WRD0.byte1=0;                                  //odeslij wartosc oczekiwana z interfejsow 10V/OT na potrzeby regulacji temperatury
            //------------------------------
            ...
            if(PFNf_stkRT||PFNf_pobPGRT||(PFNf_EnF10V&&PFNf_10VRT)||(PFNf_FOT&&PFNf_OTRT))                                 //aktywne dowolne z pobudzen RT?
            {
