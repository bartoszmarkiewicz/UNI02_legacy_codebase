...
/*---------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------*/
#define	_KNPAR  32			//domyslna ogolna liczba parametrow podlegajacych modyfikacji dla ver 5
...
#define _TKNFEXT 60			//[min] maksymalny czas aktywnosci procedury konfiguracji 
#define _TKNFSAV 2			//[s] maksymalny czas na zapis danych
/*---------------------------------------------------------------------------------*/
