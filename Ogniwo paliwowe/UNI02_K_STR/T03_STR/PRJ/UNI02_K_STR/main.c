			...
			else
			{
				...
				else
				{
					...
					else
					{
                        if(!DtKNF.cwtm)     //(timera zasobnika||LIN_CW||OT_CW)
                        {
                            w=(RdPrt(S_ERR_CW)&&(PFN.poz==_PFLTO))||((PFN.poz==_PFZMA)&&RdPrt(S_ERR_CW)&&RdPrt(S_WCW)&&RdPrt(S_PRZ_CO));
                        }
                        else                //timera zasobnika
                        {
                            w=(RdPrt(S_ERR_CW)&&(PFN.poz==_PFLTO))||((PFN.poz==_PFZMA)&&RdPrt(S_ERR_CW)&&RdPrt(S_TIM)&&RdPrt(S_PRZ_CO));
                        }
					}                    
					//awaria czujnika CW
					if(w)
