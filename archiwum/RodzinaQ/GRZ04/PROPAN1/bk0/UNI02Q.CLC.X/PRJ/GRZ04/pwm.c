...
{          
    ...
    if(_VNT_GetValue()&&!_GRZEJ_GetValue())         //zalaczony wentylator, wylaczona czesc zapalacza
    {
        ...
        StartPID(1);
        */
        if(!M._ROZRUCH||(M._ROZRUCH&&M._initVNT))       //praca wentylatora podczas w czasie wzbudzenia presostatu
        {
...
/*unsigned char GetModSTR(unsigned char l)
{
    if(l>8) l=8;
    return r1_r6[l].PPWM;
}
unsigned char GetVntSTR(unsigned char l)
{
    if(l>8) l=8;
    return r1_r6[l].VNT;
}*/
