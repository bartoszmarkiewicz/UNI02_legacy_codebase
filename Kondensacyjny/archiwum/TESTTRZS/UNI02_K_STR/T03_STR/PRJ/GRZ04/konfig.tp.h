...
typedef struct	{
        union   {
            ...
            {    
				...
				unsigned char nokr;		//liczba impulsow na obrot
				unsigned char minv;		//minimum pwm wentylatora                
				unsigned char maxv;		//maksimum pwm wentylatora  
				unsigned char strv;		//startowe pwm wentylatora                
				unsigned char aleg;     //znacznik 1 aktywacji ANTY-LEGIONELLA
				unsigned char lkm;      //dlugosc komina 
                unsigned char pwr;      //moc podgrzewacza
                float P;
                float I;
                float D;                
				}DtKONF;
