...
#define	_WERSJA_H
//----------------------------------------------------------
#define _WERSJA 17			//aktualna wersja produkcyjna oprogramowania (1=1.1, 2=1.2 ... 10=2.0) UWAGA max 16
...
- wprowadzona mozliwosc odczytu liczby godzin pracy sterownikow z oprogramowaniem w wersji >=17
 /*
							UNI-02	
				v1 									v2                                          v3
