...
#include "uart9c.tp.h"		//typy danych
/*---------------------------------------------------------------------------------*/
#define _NRS_RBF 20			//rozmiar bufora odebranych danych
#define _NRS_TBF 20			//rozmiar bufora wysylanych danych
/*---------------------------------------------------------------------------------*/
#define _NRS_BTY 16			//rozmiar bufora odebranych danych
#define _NCH_BTY 10			//rozmiar bufora wysylanych danych
/*---------------------------------------------------------------------------------*/
/*-----------------------------PUBLIC DATA-----------------------------------------*/
#define _BRGH 0				//(w trybie synch. ignorowany) 0 - low speed, 1- high speed 				
#define _SYNC 0				//0 - asynch. 1 - synch.
#define _DSBD 2400			//predkosc transmisji
