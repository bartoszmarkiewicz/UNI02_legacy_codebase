...
unsigned char LIN1SingleResponse_RD(void)
{
 ...
 /*               if(PFNf_obgCO)
                {
                    FTL1.WRD1.byte0=0b00010000;                                     //awaria/brak czujnika CS
                }
                else
                {
                    FTL1.WRD1.byte0=FTL1.WRD2.byte1&0b11101111;    
                }
                if(PFNf_obgCW)
                {
                    FTL1.WRD1.byte0=0b00100000;                                     //awaria/brak czujnika CS
                }
                else
                {
                    FTL1.WRD1.byte0=FTL1.WRD2.byte1&0b11011111;    
                }  
                if(PFNf_fL3)
                {
                    FTL1.WRD1.byte0=0b01000000;                                     //awaria/brak czujnika CS
                }
                else
                {
                    FTL1.WRD1.byte0=FTL1.WRD2.byte1&0b10111111;    
                } 
*/            
            break;
        } 
