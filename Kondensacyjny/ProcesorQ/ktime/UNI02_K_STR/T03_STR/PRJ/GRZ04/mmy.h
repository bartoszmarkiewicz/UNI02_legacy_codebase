...
#define PLOMIEN		0	
#define ALARM		1
#define VNT			3		//KOPIA VNT Z PORTE,1
#define PRZEPLYW_CO	5
#define BRAK_CIAGU	6
#define MOD_ON		7
//PORTD
#define DTF			0
...
#define ZIMA		6
//ST_GLOBAL0
#define S_CW		0		//! wymuszenie CW
#define S_RT		1		//wymuszenie RT
#define S_ALARM		2		//sygnal ALARM
#define S_PRZ_CO	3		//sygnal PrzeplywCO
#define S_BRAK_CI	4		//sygnal BrakCiagu
#define S_MOD_ON	5		//sygnal BrakModulatora
#define S_RESET		6		//sygnal ResetON
#define S_PLOMIEN	7		//sygnal PLOMIEN
//ST_GLOBAL1
