...
#define _DEMO_NZW 0         //wylaczenie symulacji czujnika zewnetrznego w trybie DEMO
...
#define _TEST_COM 0      //test komunikacji miedzy plytka sterujaca i plytka LCD (na I2C liczba bledow eksponowana na pozycji Temp.CO)
//--------------------------------------------------------------
//--------------------------------------------------------------
