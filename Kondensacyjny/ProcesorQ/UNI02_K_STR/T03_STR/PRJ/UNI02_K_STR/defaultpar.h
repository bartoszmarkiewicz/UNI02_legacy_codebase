...
#define _ADRPWTM  0x01D6        //maksimum przewyzszenia temperaturowego
...
#define _DTPGDR 1               //P26 rodzaj regulatora pogodowego
#define _DTPGDG 18              //P27 wartosc graniczna pobudzenia od regulatora pogodowego
#define _DTPGDO 5               //P28 obnizenie nocne dla regulatora pogodowego
#define _DTPGMX _MAX_PCO        //maksymalna wartosc graniczna CO dla regulatora pogodowego
#define _DTCWTM  0              //P31 we. sygnalu timera zasobnika (1F)
#define _DTCWMG  0              //P30 histereza wylaczenia CW(2F)
#define _DTPPGD  99             //domyslna wartosc nastawy KT dla aktywnego regulatora pogodowego

#define _DEFPWTM 5              //P32 maksimum przewyzszenia temperaturowego              
//---------
...
//Kotly jednofunkcyjne
#if _KODKT==1					//LABUSE
	//jednofunkcyjny
	#define _DTAMST 45			//P1 moc startowa
	#define _DTAMCW	99			//P2 moc maksymalna dla WU
	#define _DTAMCO	99			//P3 moc maksymalna dla WG
	#define _DTAPDG	0			//P8 ogrzewanie podlogowe
	#define _DTAWKK	_KODKT		//P6 wybor typu kotla (jednofunkcyjny)
	...
	#define _DTANOK 2			//P11 liczba okresow na sek. (tachometer)
	#define _DTACS5	1			//P9 czujnik cisnienia 5V
	#define _DTATAL	1			//P10 aktywacja timera AntyLegionella
	#define _DTARTA	0			//wartosc poczatkowa timera AntyLegionella
	#define _DTAOBG	1			//P7 domyslny obieg zamkniety (dot. UniCo
	#define _DTVMD _DTMMIN1		//P4 granica minimalna obrotow
	#define _DTVMG _DTMMAX1		//P5 granica maksymalna obrotow
	#define _DTRDPM	_DPWMPMP	//P12 rodzaj pompy
	#define _DTDLPM	6			//P13 delta temperaturowa CO dla pompy
	#define _DTMNPM	50			//P14 granica minimalna predkosci pompy
	#define _DTTECO	0			//P15 tryb pracy ECO
	#define _DTAECO	5			//domyslna nastawa ECO
	#define _DTTMCO2 1			//P16 czas pracy przy obnizonej mocy w trybie CO
	#define _DTMCO2	10			//P17 wartosc obnizonej mocy w trybie CO
	#define _DTMXPM	99			//P18 granica maksylna predkosci pompy
	#define _DTALIN	_MY_LADDR                       //domyslny adres LIN
	#define _DTMXPM2	99		//P19 granica maksylna predkosci pompy dla WU
	#define _DTHSCO  5			//P20 histereza wylaczenia grzania CO (ponad nastawe)
	#define _DTCONW  75			//P21 temp CO przy grzaniu CW zasobnika
	#define _DTPROP  0			//P22 poprawka dla regulagtora pogodowego
	#define _DTRFAN	_DPRFAN     //P23 rodzaj wentylatora
	#define _DTTSTR	4           //P24 czas wybiegu na mocy startowej (tryb pracy CO)
	#define _DTTL3	3           //P25 blokady L3 [min] (tryb pracy CO)
	#define _DTPGDR 1           //P26 rodzaj regulatora pogodowego
	#define _DTPGDG 18          //P27 wartosc graniczna pobudzenia od regulatora pogodowego
	#define _DTPGDO 5           //P28 obnizenie nocne dla regulatora pogodowego
//-------------------------------------------------------------------------------------
...
//Kotly dwufunkcyjne
	...
	#define _DTAMCO	99			//P3 moc maksymalna dla WG
	#define _DTAPDG	0			//P8 ogrzewanie podlogowe
	#define _DTAWKK	_KODKT		//P6 wybor typu kotla (dwufunkcyjny)
	#if _DTAPDG==0					//ogrzewanie podlogowe?
		#define _DTAPCO	_MAX_PCO	//nastawa pco
	#else
		#define _DTAPCO	_MAX_PDCO	//nastawa pco
	...
	#define _DTARTA	0			//wartosc poczatkowa timera AntyLegionella
	#define _DTAOBG	1			//P7 domyslny obieg zamkniety (dot. UniCo
	#define _DTVMD _DTMMIN2		//P4 granica minimalna obrotow
	#define _DTVMG _DTMMAX2		//P5 granica maksymalna obrotow
	#define _DTRDPM	_DPWMPMP    //P12 rodzaj pompy
	#define _DTDLPM	6			//P13 delta temperaturowa CO dla pompy
	#define _DTMNPM	50			//P14 granica minimalna predkosci pompy
	#define _DTTECO	0			//P15 tryb pracy ECO
