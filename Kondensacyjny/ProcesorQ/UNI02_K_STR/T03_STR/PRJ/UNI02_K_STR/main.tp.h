...
typedef struct	{
        ...
        union   {
            ...
            {   
                ...
                unsigned _LIN_UP:1;         //zdalny znacznik pobudzenia grzania na wysokich paramertach                
            };
        };
        union   {
            unsigned char flag9;
            ...
            {   
				...
				unsigned _pob_UP:1;			//pobudzenie grzania na wysokich paramertach
                unsigned _LIN_BPSS:1;       //zdalny znacznik bypass dla pobudzenia RT              
                unsigned _setBPSS:1;        //bypass dla pobudzenia RT 
                unsigned _setMXCO:1;		//oktywne zdalne ograniczenie mocy [%]]
                unsigned _fl9bt5:1;        //
                unsigned _fl9bt6:1;        //
                unsigned _fl9bt7:1;         //                
            };
