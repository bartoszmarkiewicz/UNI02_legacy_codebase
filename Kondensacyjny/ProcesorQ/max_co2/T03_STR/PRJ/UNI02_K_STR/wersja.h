//----------------------------------------------------------
#define _WERSJA 20			//18aktualna wersja produkcyjna oprogramowania (1=1.1, 2=1.2 ... 10=2.0)
...
-Wprowadzono wstepne ograniczenie mocy maksymalnej dla grzania CO (aktywacja wymaga minimum 2 wersji oprogramowania LCD)
	{
		...
		Ograniczenie funkcionuje wy?ï¿½cznie w trakcie normalnego grzania obiegu CO.
...
-Wprowadzone rozwiazania kompatybilnosci wstecznej
 ...
 - punkt wy??czenia wody grzewczej dla grzania wody u?ytkowej >=91ï¿½, punkt za??czenia wody grzewczej dla grzania wody u?ytkowej <=87									 - punkt wy??czenia wody grzewczej = [nastawa +10ï¿½] ale nie wi?cej ni? [maksymalna wartoï¿½? nastawy +5ï¿½] 
...
Wersja 6 (28.09.2015)
 ...
 - dodano komendy zdalnego sterowania z magistrali LIN (mozliwoï¿½? zmiany parametrow pracy)
...
- rekalibracja wentylatora po zmianie parametru P23(rodzaj wentylatora) i wyjï¿½ciu z procedury konfiguracji
...
- wprowadzony obnizony do 30% wybieg pompy na czas przelaczania zaworu 3Dr (5 sek.)
- wprowadzony licznik godzin pracy
 */

/*wersja 18 01.06.2021, 14.06.2021
...
(11.05.2022)
- przed?uzony czas dla detekcji zaniku przeplywu przy obiegach otwartych
(23.06.2022)
- ustawiono domyslna wartosc parametru pracy automatycznej antylegionella P10 na 1
...
(30.09.2022)
- wprowadzone zabezpieczenie od przekroczenia progu temperaturowego na powrocie obiegu CO
 */

/*wersja 20 15.03.2023, 
- wprowadzony parametr konfiguracyjny P33 na potrzeby wyboru rodzaju czujnika przeplywu CW
- wprowadzony parametr konfiguracyjny P34 czasu wybiegu pompy CO 
- wartosc domyslna P18 zmianiona z 80 na 99
- wartosc domuslna P24 zmieniona z 20 na 4
- optymalizacja zapisu parametrow konfiguracyjnych
(17.08.2023)
- wprowadzona detekcja pracy z plytka wyswietlacza z potencjometrami
...
(05.09.2023)
- poprawiona wartosc przeplywu CW przesylana do plytki wyswietlacza
- poprawiona reakcja na aktywacje trybu BYPSS
(08.09.2023)
- poprawka dla wartosci flagi _STK_CW2 ze wzgledu na rodzaj czujnika przeplywu CW
(31.10.2023)
- aktualizacja wartosci domyslnych parametrow konfiguracyjnych
- w trybie produkcyjnym czasowy wybieg na mocy minimalnej jest dezaktywowany
(11.11.2023)
- poprawiona informacja I2C o rodzaju plytki wyswietlacza (KPOT)
(21.11.2023)
- tryb demo uwzglednia prace z regulacja temperatury za sprzeglem
(03.12.2023)
- obsluga zdalnego wzglednego ogranicznika mocy //ooo 
(15.01.2024)
- wprowadzony tryb testowy dla detekcji problemow komunikacji miedzy plytka sterujaca a plytka wyswietlacza 
(21.01.2024)
- wprowadzona BLOKADA 15sek. po grzaniu na parametrach wysokich (zapobieganie blokadzie 3M po przerwaniu grzania na parametrach wysokich)
(23.01.2024)
- optymalizacja procedur obslugi pobudzenia pracy na parametrach wysokich
)23.07.2024)
- zalaczenie grzania mozliwe tylko przy temperaturze zasilania nizszej o 1 stopien od nastawy
 */
 /*  
							UNI-02	
				v1 											v2                                      v3									v4
