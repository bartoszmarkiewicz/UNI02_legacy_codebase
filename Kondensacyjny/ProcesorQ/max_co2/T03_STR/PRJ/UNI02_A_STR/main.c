...
//UWAGA:
    ...
    //M.STRB=1,M.STRB=2
    //Dezaktrywacja przedbiegu pompy
    //Dezaktywacja blokady dla zaworu 3DR na obieg CO w przypadku kotlow 1F przy TCW>85C
...
void RefLCDData(void)
{
    ...
    InBitSet(&RSDT1.outSTAT3,_POB_PGRT,wr);                                 //pobudzenie RT od regulatora pogodowego
    */
...
void DecSTR(void)
{
	...
	if(M._pob_SRW&&!M._ROZRUCH&&_GRZEJ_GetValue())
	{
		if(InGetBit(RSDT1.inSTAT1,_SRVMAX)) WritePWM(_MG2_MOD);		//tryb serwisowy z moca maksymalna?
