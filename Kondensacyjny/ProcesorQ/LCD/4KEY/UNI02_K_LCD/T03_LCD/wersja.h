...
- usprawniono wy�wietlanie w przypadku powt�rnej procedury kalibracji wentylatora
...
(22.09.2023)
- wprowadzony konfiguracja parametrow modulow automatyki    //kkk
(23.09.2023)
- poprawiona konfiguracja parametrow modulow automatyki
- dodana automatyzacja nadawania adresu
(04.10.2023)
- optymalizacja procedury nadawania adresu ALIN      //nnn
(06.10.2023)
- poprawa wyswietlania min/max przy modyfikacji nastaw PCO/PCW/ECO      //mmm
- poprawa reakcji na przycisniecie przycisku zmiany nastawy CW z nieaktywnym trybem Eco
(18.10.2023)
...
(03.12.2023)
- Wprowadzenie obslugi Maximum relative modulation level setting z interfejsu OT
(07.01.2024)
- Poprawa algorytmu testu aktywnosci interfejsu OT 
- Poprawa algorytmu testu aktywnosci interfejsu 10V  
(09.01.2024)
- modyfikacja pakietu dalnych udostepnianych na zapytanie _CLIN_RRD_SETPP (LIN)
(10.01.2024)
- poprawa aktualizacji wartosci PFN.IINSETP
(11.01.2024)
- modyfikacja pakietu dalnych udostepnianych na zapytanie _CLIN_RRD_SETPP (LIN)
- wprowadzona funkcja obslugi BYPASS dla aktualizacji wartosci MXCO z interfejsu OT
(14.01.2024)
- rozwiniecie trybu testowego interfejsu 10V
(15.01.2024)
- uzupelnienie danych przesylanych na zapytanie _CLIN_RRD_SETPP (LIN) o informacje o aktywnosci interfejsow 10V/OT
(20.01.2024)
