...
#define _KEY_BBOARD 1       //rodzaj klawiatury (0-cztery przyciski 1-siedem przyciskow)
#if (_EXT_BOARD==0)
...
#define _TEST_BPSS  0       //test bypass dla sygnalu RT

#define _TEST_IOT   0       //tryb testowy interfejsu OT

#define _TEST_10V   0       //tryb testowy interfejsu 10V
#define _TKEY_10V   0       //tryb testowy interfejsu 10V z dowiazaniem przyciskow SET,RES
//--------------------------------------------------------------
...
#define _RTLKONFI 9			//konfigLIN.c - timer konfiguracji  //kkk

//RTM
#define _RTKONF3 0			//konfig.c - timer aktywnosci konfiguracji
#define _RTFSR	 1			//konsola.c
#define _RTALG	 2			//konsola.c
#define _RTLKONF 3			//konfig.c - timer aktywnosci konfiguracji  //kkk
...
#define _LN_BPSS  1     //bupass dla sygnalu RT //+++
