...
#define	_WERSJA_H
//----------------------------------------------------------
#define _WERSJA 20			//18aktualna wersja produkcyjna oprogramowania (1=1.1, 2=1.2 ... 10=2.0) UWAGA max 16
 ...
 */
/*wersja 17 01.06.2021
- wprowadzony licznik godzin pracy
 */
/*wersja 18 01.06.2021
- wprowadzony parametr konfiguracyjny na potrzeby regulacji temperatury za sprzeglem
- poszerzony zakres adresow LIN (1..4,5,9..12)
- zmiana zakresu dla parametru P21 z 70-89 na 50-89
(03.10.2022)
 - wprowadzenie restartu oprogramowania w przypadku braku komunikacji z plytka sterujaca
 - poprawiony zakres zmian parametru odpowiedzialnego za wartosc maksymalna przewyzszenia temperaturowego
 */
/*wersja 20 10.05.2023
- wprowadzony parametr konfiguracyjny P33 (rodzaj czujnika przeplywu CW (0-stykowy, 1-impulsowy) (2F))
- wprowadzony parametr konfiguracyjny P34 (czas wybiegu pompy CO)
- przed³u¿ony czas aktywnosci konfiguaracji z 10 min na 60 min
- optymalizacja zapisu parametrow konfiguracyjnych

(02.07.2023) Pierwsza wersja interfejsu z dwoma potencjometrami (zgodnosc programowa z wersja 19 - zachowana numeracja oprogramowania)
- modyfikacja dzia³ania przycisków pod k±tem interfejsu z dwoma potencjometrami
(22.07.2023)
- zwiekszony czas oczekiwania na ramke zwrotna danych z plytki sterujacej (_RS_TOUT)
(24.07.2023)
- zwiekszony czas oczekiwania na rozpoczecie transmisji (_TS_TSTR)
- zwiekszony czas timeout dla transmisji (_TS_TOUT) 
- poprawka dla reakcji na zmiany zakresow nastawnikow PCW/PCO
- wprowadzona sygnalizacja modyfikacji nastawy PCO/PCW z poziomu interfejsu LIN/OT
(25.07.2023)
- wprowadzona detekcja stabilnosci stanu nastaw PCO/PCW
- poprawa sygnalizacji modyfikacji nastawy PCO/PCW z poziomu interfejsu LIN/OT
(01.08.2023)
- wprowadzone opoznienie wysylki parametrow PCO, PCW do plytki sterujacej
- poprawiona procedura ustawiania flag stabilnosci wyniku pomiaru PCO/PCW.
- (!) dezaktywacja interfejsu 10V do wyjasnienia
(15.08.2023)
...
- wprowadzona procedura wyswietlania przeplywu CW
(22.08.2023)
- wprowadzony migajacy symbol "kran" przy grzaniu na parametrach wysokich
(29.08.2023)
- wprowadzona obsluga BYPASS
(01.09.2023)
- wprowadzony tryb symulacji generowania wartosci SETP przez interfejs 10V
- zmodyfikowana procedura powolnej zmiany wartosci SETP
(03.09.2023)
- wprowadzona informacja zwrotna na zapytanie _CLIN_RRD_SETP2
(04.09.2023)
- wprowadzona informacja zwrotna na zapytanie _CLIN_RRD_OTNST
- poprawki dla obslugi BYPASS
(05.09.2023)
- wprowadzony tryb testowy dla interfejsu OT (symulacja odebrania danych)
(05.10.2023)
- optymalizacja procedury nadawania adresu ALIN      //nnn
(10.10.2023)
- optymalizacja filtracji nastaw PCO/PCW, zwiekszony margines filtracji przy aktywnym interfejsie LIN
- poprawa warunku wejscia do procedury konfiguracji KPAR (tryb OFF, dlugie nacisniecie przycisku BAR)
(18.10.2023)
- poprawa wyswietlania wartosci docelowej temperatury przy uruchomieniu obiegu CO
- poprawa warunku modyfikacji nastawy ECO
(20.10.2023)
- poprawa obslugi PCO/PCW przy aktywnych interfejsach
- powrot wyswietlania wartosci maksymalnej przy uruchomieniu obiegu CO
(23.10.2023)
- poprawa obslugi PCO/PCW przy aktywnych interfejsach (blokada czasowa zapisu nastawy z intefejsu OT po zmianie nastawy nastawnikiem)
- poprawa procedury interpretacji nastaw po przywroceniu zasilania
(29.10.2023)
- optymalizacja procedury komunikacji na interfejsie LIN
(15.01.2024)
- modyfikacja pakietu dalnych udostepnianych na zapytanie _CLIN_RRD_SETPP (LIN)
- wprowadzona funkcja obslugi BYPASS dla aktualizacji wartosci MXCO z interfejsu OT
(25.01.2024)
- aktualizacja wartosci PFN.EXFLG i PFN.STFLG
(17.03.2024)
