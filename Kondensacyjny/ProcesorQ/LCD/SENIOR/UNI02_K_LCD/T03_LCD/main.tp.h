 ...
 */
				...
				volatile bit PFNf_hi_ncw;	//aktywna reakcja na zmiane nastawy PCW +/-5
                volatile bit PFNf_hi_nco;	//aktywna reakcja na zmiane nastawy PCO +/-5

				volatile bit PFNf_prn_res;		//wymuszony wskaz kolejnych parametrow
				volatile bit PFNf_prn_bar;		//wymuszony wskaz cisnienia                
                ...
                volatile bit PFNf_FEXT;               //aktywnosc interfejsu LIN lub OT   
                volatile bit PFNf_bFEXT;               //aktywnosc interfejsu LIN lub OT                  
                ...
                volatile bit PFNf_new_IMXCO;             //flaga nowej nastawy IPCO z interfejsu OT                
                
				volatile bit PFNf_newPOZ;                
...
//----------------------                
                volatile bit PFNf_no_wrtPCO;
                volatile bit PFNf_no_wrtPCW;

                volatile bit PFNf_no_wrtPCO2;       //zzz
                volatile bit PFNf_no_wrtPCW2;       //zzz
...
*/
    union   {
            ...
            {  
                ...
                unsigned _LOW:1;       //znacznik pracy ponizej dolnego progu mocy (nie obslugiwany)         
                unsigned _HIGH:1;      //znacznik pracy powyzej gornego progu mocy (nie obslugiwany)      
                unsigned _enEXFL:1;    //znacznik aktywnosci EXFLG               
            }; 
    }; 
    union   {
            ...
            {  
                ...
                unsigned _FTRB:2;                               
                unsigned _FRDZ:2;
                unsigned _enSTFL:1;    //znacznik aktywnosci EXFLG                 
            }; 
    };                 
                ...
                unsigned char IINSETP;
                unsigned int IPCO; //jjj
                unsigned int IPCW;                
...
//    }; 
    ...
    unsigned char OT_MXCO;
    unsigned char IOT_MXCO;    
    unsigned char LN_MXCO;    
