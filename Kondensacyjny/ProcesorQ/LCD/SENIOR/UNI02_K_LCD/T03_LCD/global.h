...
#if _KEY_BBOARD!=0
#error Wsparcie tylko dla klawiatury 2 przyciski!
#endif
//--------------------------------------------------------------
//--------------------------------------------------------------
...
#define _RTALIN 10
#define _RTFOT 11
#define _RTPBAR	12			//konsola.c
#define _RTPMCO	13			//pomiar.c
#define _RTPMCW	14			//pomiar.c
...
#define _RTSTBCO  7          
#define _RTSTBCW  8
#define _RTPLIN   9            //60timer dla  zdalnych parametrow (status)
#define _RTPLIN2  10            //61timer dla  zdalnych parametrow (pobudzenia stref)
#define _RTLKONFI 11			//konfigLIN.c - timer konfiguracji  //kkk
...
//    #define SS_KDW			3		//WE
    ...
    #define SS_RES			0		//WE
    #define SS_BAR			1		//WE
    #define SS_BAR_RES		2		//WE
    #define SS_BAR_NRES		3		//WE
