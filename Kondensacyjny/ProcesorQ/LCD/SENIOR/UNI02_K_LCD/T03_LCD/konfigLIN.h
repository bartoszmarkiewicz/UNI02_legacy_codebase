...
#include "konfigLIN.tp.h"		//typy danych
#include "keypad.tp.h"		//parametry lokalne

/*---------------------------------------------------------------------------------*/
#define _TLKNFINI 10		//[s] maksymalny czas na inicjalizacje danych
#define _TLKNFEXT 15        //[min] maksymalny czas aktywnosci procedury konfiguracji 
/*---------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------*/
//lokalne
void RdEEParam(void);
...
//print.c
extern void PrintPR2(const unsigned char lkod,unsigned char nkod,unsigned char tryb);
extern void ClsScr(void);
extern void PrintWPR2(signed int dt,unsigned char fl);
...
extern void ReadParam(signed int *param,unsigned char *zmiana,unsigned char *zapis,signed int min, signed int max, unsigned char rckl, unsigned char fst);      //kkk
...
extern void ReadParamCW(signed int *param,unsigned char *zmiana,unsigned char *zapis,signed int min, signed int max, unsigned char rckl, unsigned char fst);        //kkk
...
extern void ReadParamCO(signed int *param,unsigned char *zmiana,unsigned char *zapis,signed int min, signed int max, unsigned char rckl, unsigned char fst);    //kkk
//extern void ReadParamONE(unsigned int *param,unsigned char *zmiana,unsigned char *zapis,unsigned int min, unsigned int max, unsigned char rckl, unsigned char fst);
extern void ReadParamONE(signed int *param,unsigned char *zmiana,unsigned char *zapis,signed int min, signed int max, unsigned char rckl, unsigned char fst);   //kkk
...
extern unsigned char ALINtoNR(const unsigned char alin);
