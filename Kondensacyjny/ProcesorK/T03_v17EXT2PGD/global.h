...
#define _PRGVNT 50      //[%] minimalna predkosc wentylatora w momencie przelaczenia zaworu 3Dr dla ktorej nast?puje obni?enie predko?ci wentylatora (na czas przelaczenia) do poziomu _PNWVNT
#define _PNWVNT 50      //[%] wartosc obnizenia predkosci wentylatora na czas przelaczenia zaworu 3Dr (po spelnieniu warunku _PRGVNT) 
//------------------- 
//-------------------
